...
class TokenProviderTest {
    ...
    void generateToken() {
        ...
        String token = tokenPovider.generateToken(testUser, Duration.ofDays(14));
    ...
    void validToken_invalidToken() {
        ...
        boolean result = tokenPovider.validToken(token);
    ...
    void getAuthentication() {
        ...
        Authentication authentication = tokenPovider.getAuthentication(token);
    ...
    void getUserId() {
        ...
        Long userIdByToken = tokenPovider.getUserId(token);
