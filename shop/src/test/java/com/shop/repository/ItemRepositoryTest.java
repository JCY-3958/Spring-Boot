...
public class ItemRepositoryTest {
    ...
    public void findByPriceLessThanOderByPriceDesc() {
        this.createItemList();
    ...
    /*@Test
    @DisplayName("id가 6이상인 값 출력")
    public void findByIdGreaterThanEqual() {
        this.createItemList();
        List<Item> itemList = itemRepository.findByIdGreaterThanEqual(6L);
        for(Item item : itemList) {
            System.out.println(item.toString());
        }
    }*/
